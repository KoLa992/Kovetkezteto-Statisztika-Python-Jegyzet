...
Első ránézésre minden rendben, de nézzük csak össze ennek a szűkített modellnek az \(R^2\) értékét az eredeti modell \(R^2\) értékével, ami még tartalmazta a hengerűrtartalmat és a teljes tömeget! Ezt legkönnyebben úgy tudjuk megkérdezni, hogy mindkét modellnek lekérdezzük az \texttt{rsquared} tulajdonságát.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{[autos\_modell.rsquared, autos\_modell\_szuk.rsquared]}
\end{Highlighting}
\end{Shaded}
...
Ajjaj! A modellünk magyarázóereje leromlott \(72.72\%\)-ra az eredeti \(72.79\%\)-ról! De hát azért eléggé nem szignifikánsnak kinéző változókat szedtünk ki! A legalacsonyabb t-próba p-érték \(65.9\%\) volt a kihagyott magyarázóváltozók között (\textbf{Teljes\_tomeg})! Miért csökken az \(R^2\)?
...
Az ábráról láthatjuk, hogy a pontokra a legreálisabb illeszkedést a 3 db magyarázóváltozót (\(x^3, x^2, x\)) használó \emph{Harmadfokú} görbe adja. De az \(R^2\) mégis a legtöbb magyarázóváltozót használó Hetedfokú opciót részesíti előnyben a \emph{túltanulás} miatt!

Ennek kiküszöbölésére bevezetjük a korrigált \(R^2\) mutatót:

\includegraphics[width=0.5\textwidth,height=\textheight]{AdjR2.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{Tultan2.jpg}

A \(\bar{R}^2\) mutató értékét megtaláljuk a sima \texttt{summary} függvény eredménytáblájában is, de praktikusabb lekérdezni, mint a regressziós modellek \texttt{rsquared\_adj} tulajdonsága.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{[autos\_modell.rsquared\_adj, autos\_modell\_szuk.rsquared\_adj]}
\end{Highlighting}
\end{Shaded}
