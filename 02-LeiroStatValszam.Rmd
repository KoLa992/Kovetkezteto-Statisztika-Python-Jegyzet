...
### Súlyozott átlag és szórás Pythonban
...
## A normális eloszlás és sűrűségfüggvénye
...
knitr::include_app("https://kola992.shinyapps.io/normaldensityplot/",
                   height = "500px")
```
</center>
...
knitr::include_app("https://kola992.shinyapps.io/normalprobabilities/",
                   height = "600px")
```
</center>

### Valószínűség vs Relatív Gyakoriság
...
<center>
```{r, echo=FALSE, out.width="120%"}
knitr::include_app("https://kola992.shinyapps.io/normalprobabilities/?distr=Exp",
                   height = "550px")
```
</center>
...
### További minőségi ismérvek és a kokainmennyiség
